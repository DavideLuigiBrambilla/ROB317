...
# ParamÃ¨tres du dÃ©tecteur de points d'intÃ©rÃªt
feature_params = dict( maxCorners = 10000,
                       qualityLevel = 0.01,
                       minDistance = 5,
                       blockSize = 7 )

# ParamÃ¨tres de l'algo de Lucas et Kanade
lk_params = dict( winSize  = (15,15),
                  maxLevel = 5,
                  criteria = (cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_COUNT, 10, 0.03))

# Extraction image initiale et dÃ©tection des points d'intÃ©rÃªt
...
while(ret):
    ...
    # Mis Ã  jour image et dÃ©tection des nouveaux points
