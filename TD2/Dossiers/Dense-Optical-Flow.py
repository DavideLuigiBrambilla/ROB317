...
ret, frame1 = cap.read() # Passe Ã  l'image suivante
prvs = cv2.cvtColor(frame1,cv2.COLOR_BGR2GRAY) # Passage en niveaux de gris
hsv = np.zeros_like(frame1) # Image nulle de mÃªme taille que frame1 (affichage OF)
hsv[:,:,1] = 255 # Toutes les couleurs sont saturÃ©es au maximum
